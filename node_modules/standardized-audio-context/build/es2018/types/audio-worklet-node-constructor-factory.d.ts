...
export declare type TAudioWorkletNodeConstructorFactory = (createAudioParam: TAudioParamFactory, createAudioWorkletNodeRenderer: TAudioWorkletNodeRendererFactory, createNativeAudioWorkletNode: TNativeAudioWorkletNodeFactory, gainNodeConstructor: TGainNodeConstructor, isNativeOfflineAudioContext: TIsNativeOfflineAudioContextFunction, nativeAudioWorkletNodeConstructor: null | TNativeAudioWorkletNodeConstructor, noneAudioDestinationNodeConstructor: TNoneAudioDestinationNodeConstructor) => TAudioWorkletNodeConstructor;
