...
export const createNativeWaveShaperNodeFakerFactory = (createInvalidStateError, createNativeAudioNode, createNativeGainNode) => {
    return (nativeContext, _a) => {
        var { curve, oversample } = _a, audioNodeOptions = tslib_1.__rest(_a, ["curve", "oversample"]);
        ...
        const invertGainNode = createNativeGainNode(nativeContext, Object.assign({}, audioNodeOptions, { gain: -1 }));
        const outputGainNode = createNativeGainNode(nativeContext, Object.assign({}, audioNodeOptions, { gain: 1 }));
        const revertGainNode = createNativeGainNode(nativeContext, Object.assign({}, audioNodeOptions, { gain: -1 }));
